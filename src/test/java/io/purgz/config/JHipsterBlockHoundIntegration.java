...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("io.purgz.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("io.purgz.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
