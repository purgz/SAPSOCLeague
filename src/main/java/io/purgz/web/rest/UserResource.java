package io.purgz.web.rest;

import io.purgz.config.Constants;
import io.purgz.domain.User;
import io.purgz.repository.UserRepository;
import io.purgz.security.AuthoritiesConstants;
import io.purgz.service.MailService;
import io.purgz.service.UserService;
import io.purgz.service.dto.AdminUserDTO;
import io.purgz.web.rest.errors.BadRequestAlertException;
import io.purgz.web.rest.errors.EmailAlreadyUsedException;
import io.purgz.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link io.purgz.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
