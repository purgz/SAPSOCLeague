...
export class RoundComponent implements OnInit {
  ...
  trackId = (_index: number, item: IRound): number => this.roundService.getRoundIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.rounds = this.refineData(dataFromBody);
  }

  protected refineData(data: IRound[]): IRound[] {
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.roundService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
